...
# (black -> splash -> first scene) instead of one post-mortem frame of a window
# that has already been torn down. A PNG of a few hundred bytes is a uniform
# screen; tens of kB of neighbours means real frames.
#
#   SECS=25 bash /work/scripts/frames.sh
#
