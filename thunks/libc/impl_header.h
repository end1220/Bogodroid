...
extern "C" ABI_ATTR int statvfs_impl(const char *, struct statvfs *);
extern "C" ABI_ATTR int statvfs64_impl(const char *, struct statvfs64 *);
extern "C" ABI_ATTR int fstatvfs_impl(int, struct statvfs *);
extern "C" ABI_ATTR int fstatvfs64_impl(int, struct statvfs64 *);
extern "C" ABI_ATTR int statfs_impl(const char *, struct statfs *);
extern "C" ABI_ATTR int statfs64_impl(const char *, struct statfs64 *);
extern "C" ABI_ATTR int fstatfs_impl(int, struct statfs *);
extern "C" ABI_ATTR int fstatfs64_impl(int, struct statfs64 *);
